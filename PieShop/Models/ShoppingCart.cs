...
namespace PieShop.Models
{
    public class ShoppingCart : IShoppingCart
    {
        ...
        private ShoppingCart(PieShopDbContext PieShopContext)
        {
            _PieShopDbContext = PieShopContext;
        }
        ...
        public static ShoppingCart GetCart(IServiceProvider services)
        {
            ...
            PieShopDbContext context = services.GetService<PieShopDbContext>() ?? throw new Exception("Error initialising");
